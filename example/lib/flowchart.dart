...
class Start extends StatelessWidget {
  ...
  const Start({Key? key, required this.data}) : super(key: key);
...
class Document extends StatelessWidget {
  ...
  const Document({Key? key, required this.data}) : super(key: key);
...
class Process extends StatelessWidget {
  ...
  const Process({Key? key, required this.data});
...
class Decision extends StatelessWidget {
  ...
  const Decision({Key? key, required this.data});
...
class End extends StatelessWidget {
  ...
  const End({Key? key, required this.data});
